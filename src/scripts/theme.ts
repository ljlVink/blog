...
window
  ...
  .addEventListener("change", ({ matches: isDark }) => {
    // Only sync to system changes when the site is configured to follow system
    // and the user hasn't already chosen an explicit theme.
    if (initialColorScheme || hasStoredTheme()) return;
